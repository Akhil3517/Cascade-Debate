...
//         <button className="bg-[#ffd700] text-[#1a237e] hover:bg-[#ffeb3b] py-3 px-6 rounded-lg font-semibold uppercase tracking-wide transition-colors duration-300 animate-pulse-button">
//           Enter the Realm
//         </button>
//       </div>
//     </div>
